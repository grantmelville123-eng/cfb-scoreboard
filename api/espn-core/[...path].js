// Vercel Function: catch-all proxy /api/espn-core/* -> https://sports.core.api.espn.com/*
//
// Vercel routes every path under /api/espn-core/ to this file because of the
...
//
// Why a proxy at all: season leaders live here, and this host 403s data-centre IPs
// without a browser User-Agent. Also used for the athlete $ref lookups the
// leaders payload points at.
//
...
const ORIGIN = "https://sports.core.api.espn.com";
const PREFIX = "/api/espn-core/";
const MAX_AGE = 300;
